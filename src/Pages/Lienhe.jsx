export default function Lienhe() {
	return (
		<div className="bg-blue-50 flex items-start justify-center pt-20">
			<div className="card bg-base-100 shadow-xl w-full max-w-3xl mx-4">
				<div className="card-body">
					...
					<div className="space-y-4 text-lg">
						<p>
							<span className="font-semibold">Hotline:</span> 0123
							456 789
						</p>
						...
						<p>
							...
							66 ngách 371/9 Kim Mã, Phường Giảng Võ, Thành phố Hà
							Nội, Việt Nam
						</p>
					</div>
				</div>
